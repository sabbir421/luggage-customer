  ...
  return (
    <RootLayout>
      <main className="flex min-h-screen flex-col justify-between pl-4 pr-4">
        <Hero area={" in United-state"} />

        <section>
          <HowItWorksSection />
        </section>
        <section>
          <WhyChooseUs area={"United-state"} />
        </section>
        <section>
          <LuggageStorageCarousel area={"United-state"} />
        </section>
        <section>
          <CityGuideSection area={"United-state"} />
        </section>
        ...
        >
          <div className="container mx-auto">
            <h2 className="text-3xl font-semibold text-center text-gray-800 mb-8">
              Customer Reviews in United-state
            </h2>
